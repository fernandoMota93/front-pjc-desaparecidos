...
<template>
  <div :class="{
    ...
    <div :class="[layoutAsidePadding, { 'ml-60 lg:ml-0': isAsideMobileExpanded }]"
      ...
      <NavBar :class="[layoutAsidePadding, { 'ml-60 lg:ml-0': isAsideMobileExpanded }]" @menu-click="menuClick">
      ...
      <slot />
      <FooterBar>
        <a href="https://geia.pjc.mt.gov.br/" target="_blank" class="text-blue-600"> - Policia Judiciaria Civil de Mato
          Grosso.</a>
      </FooterBar>
    </div>
  </div>
